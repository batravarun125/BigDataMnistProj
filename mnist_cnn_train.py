...
def train():
    ...
    for epoch in range(training_epochs):
        ...
        for j in range(0, 10):
            ...
            for i in range (0,len(train_labels_)):
                #print (train_labels_[j])
                if train_labels_[i][j] == 1.0:
                    train_labels_2.append(train_labels_[i])
                    train_data_2.append(train_data_[i])


        train_labels_ = train_labels_2
        train_data_ = train_data_2

        print(train_labels_[50000])
